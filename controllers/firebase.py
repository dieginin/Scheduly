...
class Firebase:
    ...
    def sign_up(self, email: str, password: str) -> Response:
        try:
            ...
            return Response("Success", user["idToken"])
    ...
    def delete_all_jobs(self) -> Response:
        ...
        return Response("Success", str(jobs_deleted))
